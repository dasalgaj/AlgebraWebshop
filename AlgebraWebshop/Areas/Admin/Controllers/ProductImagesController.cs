...
namespace AlgebraWebshop.Areas.Admin.Controllers
{
    ...
    public class ProductImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,ImageUrl,Name,Description,MainImage")] ProductImage productImage, IFormFile UploadImage)
        {
            if (UploadImage == null)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                // primjer rezultata: J:\Programiranje\.NET\AlgebraWebshop\AlgebraWebshop\wwwroot\images\123456.jpg spremanja datoteke
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,ImageUrl,Name,Description,MainImage")] ProductImage productImage, IFormFile UploadImage)
        {
