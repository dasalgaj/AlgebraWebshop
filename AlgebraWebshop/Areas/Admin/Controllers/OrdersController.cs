...
namespace AlgebraWebshop.Areas.Admin.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var db_users = _context.Users.ToList();
            db_users.Insert(0, new ApplicationUser { Id = null, UserName = "Anonymous User" });
            SelectList users = new SelectList(db_users, "Id", "UserName");
        ...
        {
            var update_oi = _context.OrderItem.Where(oi => oi.Id == orderItem.Id).FirstOrDefault();
            if (update_oi == null) return NotFound();

            decimal new_quantity = orderItem.Quantity;
            ...
            update_oi.Quantity = orderItem.Quantity;
            update_oi.Price = orderItem.Price;
            update_oi.Discount = orderItem.Discount;
            update_oi.VAT = orderItem.VAT;
        ...
        public async Task<IActionResult> CancelConfirmed(int id)
        {
            ...
            cancel_order.DiscountAmount =- order.DiscountAmount;
