    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Order(List<string> errors)
        {
            ...
            foreach(var item in cart)
            {
                ...
                {
                    errors.Add("Product " + prod.Title + " not available in desired quantity! Max available quantity  is " + prod.Quantity.ToString());
                }
            }
        ...
        public IActionResult CreateOrder(Order order, string ShippingSameAsBilling)
        {
            ...
            foreach(var item in cart)
            {
                ...
                {
                    ModelState.AddModelError("product" + prod.Id.ToString(), "Product " + prod.Title + " not available in desired quantity!");
                }
            }
